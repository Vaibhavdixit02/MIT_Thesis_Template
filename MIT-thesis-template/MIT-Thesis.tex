...
\title{Traversing Rugged Domains: Explorations in Non-convex Optimization Theory and Software}
...
% \Author{Vaibhav Kumar Dixit}{Center for Computational Science and Engineering}
\Author{Vaibhav Kumar Dixit}{Center for Computational Science and Engineering}[M.Tech., Mathematics and Computing, IIT (BHU), 2021][B.Tech., Mathematics and Computing, IIT (BHU), 2020]
% \Author{Thurston Howell III}{Department of Economics}[MBA, Ferengi School of Management, 2022]

% Use once for each degree fulfilled by thesis
% For two degrees from one department, leave the department argument blank for the second degree {}.
\Degree{Master of Science in Computational Science and Engineering}{Center for Computational Science and Engineering}
%\Degree{Master of Science in Physics}{}
%\Degree{Bachelor of Science in Mechanical Engineering}{Department of Mechanical Engineering}

% If there is more than one supervisor, use the \Supervisor command for each.
\Supervisor{Alan Edelman}{Professor of Applied Mathematics}
...
\Acceptor{Youssef M. Marzouk}{Professor of Aeronautics and Astronautics}{Co-Director, Center for Computational Science and Engineering} % \\ \> Third title}
